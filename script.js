...
const translations = {
  tr: {
    ...
    'about.p1': "Muğla Sıtkı Koçman Üniversitesi Bilgisayar Mühendisliği son sınıf öğrencisiyim. Web siteleri ve web uygulamaları geliştiriyorum.",
    'about.p2': "Üniversitede edindiğim teknik altyapıyı, yazılım firmalarında yaptığım stajlarla gerçek iş ortamında pekiştirdim. Bu birikimi freelance olarak geliştirdiğim projelere taşıdım; bu projeler bugün gerçek işletmeler tarafından aktif olarak kullanılıyor. Bir fikri alıp tasarımdan yayına kadar tüm süreci üstlenebiliyorum.",
    'about.p3': "Yapay zekâ araçlarını geliştirme sürecimin doğal bir parçası olarak kullanıyorum. En çok önemsediğim şey, yaptığım işin gerçekten çalıştığından emin olmak.",
    'about.card1.title': 'Bilgisayar Mühendisliği', 'about.card1.desc': 'Muğla Sıtkı Koçman Üniversitesi',
    ...
    'projects.avrupaoto.badge': 'Canlı Proje',
    'projects.avrupaoto.desc': "Nazilli merkezli oto çıkma parça platformu, canlıda yayında olan gerçek bir müşteri projesi. Araç markası/modeline göre parça arama ve kategori filtreleme içerir; satış site üzerinden değil WhatsApp üzerinden iletişime geçilerek yapılır.",
    'projects.tasguleroren.desc': "Aydın'daki bir avukatlık bürosu için canlıda yayında olan kurumsal web sitesi ve yönetim paneli. Makaleler, içtihatlar, çalışma alanları ve ekip panelden yönetilir; içerik TBB reklam yasağı kurallarına uygun kurgulandı.",
    ...
    'projects.flyticket.desc': "Türkiye'nin 81 ili arasında uçuş bileti satışı yapan full-stack web uygulaması. İnteraktif koltuk seçimi, kullanıcı girişi, otomatik e-bilet gönderimi ve admin paneli içerir.",
    'projects.adversarial.desc': "ML tabanlı kötü amaçlı yazılım sınıflandırıcılarına karşı saldırı ve savunma döngüsünü simüle eden araştırma projesi. Adversarial eğitim kaçış oranını %85'ten %18'e düşürdü.",
    'projects.dejaview.desc': 'Etiketlenmemiş haber metinlerini otomatik sınıflandıran ve hiyerarşik kümeleme gerçekleştiren makine öğrenmesi projesi. K-Means, GMM ve OPTICS algoritmalarını karşılaştırır.',
    'projects.travelogue.desc': "Kullanıcıların seyahatlerini fotoğraf ve notlarla belgelediği, interaktif harita üzerinde ziyaret ettikleri yerleri gördüğü ve gelecek planları yaptığı Android seyahat günlüğü uygulaması.",
    'tag.animation': 'Animasyon',
    'tag.partscatalog': 'Parça Kataloğu',
    'tag.whatsapp': 'WhatsApp İletişim',
    'tag.livesite': 'Canlı Site',
  ...
  en: {
    ...
    'about.p1': "I'm a final-year Computer Engineering student at Muğla Sıtkı Koçman University. I build websites and web applications.",
    'about.p2': "I reinforced the technical foundation I gained at university through internships at software companies, working in a real business environment. I then carried that experience into freelance projects that are actively used by real businesses today. I can take an idea and own the whole process, from design to launch.",
    'about.p3': "I use AI tools as a natural part of my development workflow. What I care about most is making sure the work I deliver actually works.",
    'about.card1.title': 'Computer Engineering', 'about.card1.desc': 'Muğla Sıtkı Koçman University',
    ...
    'projects.avrupaoto.badge': 'Live Project',
    'projects.avrupaoto.desc': "A live, real client project — an auto salvage parts platform based in Nazilli, Turkey. Includes part search by vehicle make/model and category filtering; inquiries are handled via WhatsApp rather than an on-site checkout.",
    'projects.tasguleroren.desc': "A live corporate website and admin panel for a law firm in Aydın, Turkey. Articles, case law, practice areas and team are managed from the panel; content is built to comply with the Turkish Bar Association's advertising rules.",
    ...
    'projects.flyticket.desc': "A full-stack flight ticketing app for reservations across Turkey's 81 provinces. Features interactive seat selection, user login, automated e-ticket delivery and an admin panel.",
    'projects.adversarial.desc': 'A research project simulating the attack-defense cycle against ML-based malware classifiers. Adversarial training reduced the evasion rate from 85% to 18%.',
    'projects.dejaview.desc': 'A machine learning project that automatically classifies unlabeled news texts and performs hierarchical clustering. Compares K-Means, GMM and OPTICS algorithms.',
    'projects.travelogue.desc': 'An Android travel journal app where users document trips with photos and notes, visualize visited places on an interactive map, and plan future adventures.',
    'tag.animation': 'Animation',
    'tag.partscatalog': 'Parts Catalog',
    'tag.whatsapp': 'WhatsApp Contact',
    'tag.livesite': 'Live Site',
